      ...
      {loading ? (
        ...
        <div className="flex justify-center text-richblack-5  min-h-lvh min-w-min  items-center ">
          <div className=" flex-col min-w-[330px] max-w-[420px]  justify-center items-center ">
            ...
            <p className="text-lg my-3 text-richblack-200">
            ...
            <form onSubmit={formsubmithandler}>
              ...
              <br />
              <button className="mt-2 w-full rounded-[8px] bg-yellow-50 py-[8px] px-[12px] font-medium text-richblack-900">
                Verify Email
              </button>
            </form>
            <div className="flex  justify-between px-4 py-3 cursor-pointer">
              ...
              <div
                className="flex items-center gap-2 text-richblue-200"
