...
function CourseReviewModal({ setreviewmodal }) {
    ...
    return (
        <div className="w-full md:w-[60%] h-auto text-white bg-richblack-900 absolute bottom-24 md:absolute md:bottom-20 md:left-40  lg:absolute lg:bottom-40 lg:left-72">
